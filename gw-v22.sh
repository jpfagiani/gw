...
NAT
    ...
    gen_nftables_conf() {
        ...
        printf '        # Painel Web (porta dedicada — fora do alcance do Squid)\n'
...
acl Safe_ports  port 80 443 5000 8080 21 70 210 280 488 591 777 1025-65535
...
# Permitir acesso à porta 5000 (painel) explicitamente
acl port_painel port 5000
http_access allow localnet port_painel
